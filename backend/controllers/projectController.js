  ...
  return renderModule(req, res, {
    ...
    form: {
      ...
      fields: [
        ...
        { name: 'description', label: 'Description', type: 'richtext', value: editingProject?.description || '' },
    ...
    table: {
      title: 'Projects',
      description: 'Add projects, categories, technologies, and delivery outcomes.',
      columns: [
